...
const number = await inquirer.prompt([
    ...
    { message: "Enter the number the range should end. ", type: "number", name: "lastNum" }
]);
let finalNumber = number.firstNum + Math.floor(Math.random() * (number.lastNum - number.firstNum + 1));
